...
# This script was taken from the hailo-rpi5-examples repo,
# and is therefore licensed under MIT license.

# TAPPAS CORE Definitions
CORE_VENV_NAME=".hailo-venv"
CORE_REQUIRED_VERSION=("3.30.0" "3.31.0")

# TAPPAS Definitions
TAPPAS_VENV_NAME=".hailo-tappas-venv"
